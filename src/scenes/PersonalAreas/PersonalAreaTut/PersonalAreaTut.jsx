...
import {TutorInfo} from "./components/index.js";
import {TimetableTut} from "./components/index.js";
import {StudentsList} from "./components/index.js";
    ...
    return (
        <Container fluid maw={1400} className={classes.main}>
            ...
            <Box px="md" mx="auto" pt="xs" mb="md">
                <Title order={1} align="center" mb="lg" className={classes.text}>
                    Личный кабинет
                </Title>
                <TutorInfo/>
                <Title order={2} align="center" mb="lg" className={classes.text}>
                    Расписание занятий
                </Title>
                <Tooltip
                    multiline
                ...
                <TimetableTut/>
                <Title order={2} align="center" mb="lg" mt="md" className={classes.text}>
                    Ваши ученики
                </Title>
                <StudentsList/>
            </Box>
